"""
Django settings for bersamore project.
...
SECRET_KEY = '**s_k*g=ozju$*@6g(1ykmf(&v8g_r3y+n5yzwnn*(+i4q$--p'
...
WSGI_APPLICATION = 'bersamore.wsgi.application'
